/**
 * Challenges - Sistema Unificado de Desafios
 * Exports de todos os componentes relacionados
 */

export { ChallengeCard } from "./ChallengeCard";
export { ChallengesSection, ChallengesHighlight } from "./ChallengesSection";
