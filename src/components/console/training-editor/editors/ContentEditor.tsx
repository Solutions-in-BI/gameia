            ...
            <CardContent className="pt-4 space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Escreva o conteúdo do módulo aqui... Suporta formatação básica."
                  rows={12}
                  className="font-mono text-sm"
                />
                <p className="text-xs text-muted-foreground">
                  Dica: Use **negrito**, *itálico* e # para títulos (Markdown básico)
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-4 space-y-4">
              ...
              {(module.video_url || contentData.video_url) && (
                <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                  ...
                  <span className="ml-2 text-muted-foreground">Preview do vídeo</span>
                </div>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-4 space-y-4">
              ...
              <div className="border-2 border-dashed border-muted rounded-lg p-8 text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Por enquanto, use uma URL direta para o arquivo
                </p>
              </div>
            </CardContent>
          </Card>
